...
export default function FinancialEducationScreen() {
  ...
  return (
    <ScrollView className="flex-1 p-2" style={styles.container}>
      {conteudos.map((item) => (
        <View key={item.id} className="rounded-lg mb-4" style={styles.card}>
          <Image
            source={ComoControlarGastosImg}
          ...
          <View className="p-3 gap-2">
            ...
            <Text className="text-justify leading-5" style={styles.text}>
              {item.texto}
            </Text>
          </View>
        </View>
